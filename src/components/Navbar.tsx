  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-blue-200 p-6'>
        ...
        <div className="block">
            <button
                onClick={dropDown}
                className="flex item-center px-3 py-2 text-indigo-700
                border rounded border-indigo-500 hover:text-white hover:border-white">
                    ...
                    <Button className='p-3 m-5 bg-blue-300 justify-center rounded'>
                        <div>
                            <Link to='/' onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0
                             text-indigo-700 hover:text-white mr-4'>
                                Home
                            </Link>
                        </div>
                    </Button>
